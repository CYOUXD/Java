...
//	String[] g = {"1번 그룹", "2번 그룹", "3번 그룹", "4번 그룹", "5번 그룹"};
//	String[] num = {"010-1111-1111", "010-2222-2222", "010-3333-3333", "010-4567-4557", "010-5555-5555"};
//	String[] name = {"강아지", "고양이", "햄스터", "쿼카", "강아지"};
//	
//	for(int i=0; i<num.length; i++) {
//		person.put(num[i], name[i]);
//		group.put(g[i], person.);
//	}
