...
public class UserDefineException {
	...
	public static void main(String[] args) {
		...
		try {
			memberManager.insert(new Member("홍길동", "010-1234-3847", "서울시 마포구"));
	...
	public void insert(Member member) throws DuplicateKeyException{
		...
		//DB에 홍길동/010-1234-3847 정보가 있다고 간주!
		if("홍길동".equals(member.name)&& "010-1234-3847".equals(member.phone)) {
			//이 경우에는 DB에 이미 정보가 있는 경우로 간주!
			//예외를 발생시켜 insert 메서드 호출한 곳으로 데이터가 중복됨을 알려줘야 함!
